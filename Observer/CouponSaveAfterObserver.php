...
class CouponSaveAfterObserver implements ObserverInterface
{
    ...
    /**
     * CouponSaveAfterObserver constructor
     *
    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            $this->_queue->scheduleJob(CouponHandler::class, 'handle', [$rule->getCouponCode(), $rule->getId()]);
            $this->_logger->debug("Scheduled sync job for coupon code: {$rule->getCouponCode()}, rule ID: {$rule->getId}");
        } catch (Exception $e) {
